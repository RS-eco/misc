...
author: "William Michener 1997 - Ecological Applications"
date: "1997"
...
2. Abstract: Descriptive abstract summarizing research objectives, data contents (includ- ing temporal, spatial, and thematic domain), context and potential uses of data set 
...
5. Abstract: Descriptive abstract summarizing broader scientific scope of "overall" re- search project 
...
c. Data collection: period, frequency, Information necessary to understand temporal sampling regime etc. 
...
d. Permit history: References to pertinent scientific and collecting permits e. Legal/organizational requirements Relevant laws, decision criteria, compliance standards, etc. 
...
b. List and definition of variable Description of any codes associated with variables codes 
...
Description of missing data, anomalous data, calibration errors, etc. Class 
...
4. Questions and comments from secondary users: Questionable or unusual data discovered by secondary users, limitations or  problems encountered in specific applications of data, unresolved questions or comment
